class RequirementModel {
  ...
  factory RequirementModel.fromJson(Map<String, dynamic> json) {
    ...
    return RequirementModel(
      ...
      minBudget: double.tryParse((json['minBudget'] ?? json['budget_from'] ?? '').toString()) ?? 0.0,
      maxBudget: double.tryParse((json['maxBudget'] ?? json['budget_to'] ?? '').toString()) ?? 0.0,
      minArea: json['minArea'] != null || json['min_area'] != null ? double.tryParse((json['minArea'] ?? json['min_area']).toString()) : null,
      maxArea: json['maxArea'] != null || json['max_area'] != null ? double.tryParse((json['maxArea'] ?? json['max_area']).toString()) : null,
      areaIds: aIds,
      areaNames: aNames,
